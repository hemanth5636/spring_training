...
public class EmployeeFeignClientApplication {
	...
	@RequestMapping(value = "/ha/{id}")
	public Object ha(@PathVariable(value = "id") String id, @RequestBody Object userEntity) {
		return userClient.ha(id, userEntity);
	}
	
	@RequestMapping(value = "/getAllUsers", method = RequestMethod.GET)
	public Object getAllUsers() {
		System.out.println("in get all users "+this);
	...
	interface UserClient {
		...
		@RequestMapping(value = "/ha/{id}")
		Object ha(@PathVariable(value = "id") String id, @RequestBody Object userEntity);
